...
\begin{enumerate}
    ...
    \item 
        ...
        \\(+0.5 marks) Attempt at proving regularity using any DFA/NFA or regular expression etc.
        \\(+0.5 marks) Given DFA/NFA or regular expression starts and ends with \(\texttt{\#}\).
        \\(+0.5 marks) All strings in language are accepted by DFA/NFA or recognized by regular expression.
        \\(+0.5 marks) All strings NOT in language are rejected by DFA/NFA or NOT recognized by regular expression.
        \\(-2 marks) Language not shown to be regular/ Use of pumping lemma to show regularity/ Plagiarism/ No solution given.
