...
\begin{enumerate}
    ...
    \item
        ...
        \\\textbf{b)} Observe all strings in B start and end with any one of these strings \{\(aa, ab, ba, bb\)\}, and can have any other characters including empty string in between.

        \textbf{Grading Scheme:}
        \\+0.5 marks - Attempt at making any regular expression for all parta.
        \\+1 mark - \(abbbb^*\Sigma^*\) or equivalent expression for \textbf{(a)}
        \\+1 mark - All strings NOT in language rejected by automaton.
        \\+1 mark - Automaton clearly some NFA.
        \\-5 marks -  Plagiarism/ No solution given.
    % 6.
